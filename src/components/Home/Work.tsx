...
const Work = ({
  ...
  const elems = [
    {
      heading: "BridgeOps",
      subHeading: "Operations dashboard platform",
      video: workvid1,
      image: workimg1,
    },
    {
      heading: "Nova Commerce",
      subHeading: "Premium storefront experience",
      video: workvid2,
      image: workimg2,
    },
    {
      heading: "Pulse AI",
      subHeading: "Applied intelligence interface",
      video: workvid3,
      image: workimg3,
    },
    {
      heading: "Atlas CRM",
      subHeading: "Client workflow system",
      video: workvid4,
      image: workimg4,
    },
  ];
